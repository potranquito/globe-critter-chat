-- Create spatial matching functions for species-ecoregion linking
-- Run this first, then run populate-only.sql
...
-- Function 3: Get species for a specific ecoregion
