-- Update database functions to return habitat_info field
-- This enables habitat descriptions to flow through to the frontend

-- Update get_balanced_ecoregion_species to include habitat_info
...
COMMENT ON FUNCTION get_balanced_ecoregion_species IS 'Returns species from an ecoregion with balanced taxonomic diversity, including habitat_info field';


-- Update get_balanced_spatial_species to include habitat_info
...
COMMENT ON FUNCTION get_balanced_spatial_species IS 'Returns species from a spatial region with balanced representation and habitat_info field';
