#!/usr/bin/env python3
"""
Add Wikipedia image to Arctic Terrestrial ecoregion
"""
...
# Ecoregion data
ecoregion_data = {
    "name": "Arctic Terrestrial",
    "image_url": "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/Arctic_%28orthographic_projection_with_highlights%29.svg/330px-Arctic_%28orthographic_projection_with_highlights%29.svg.png",
    "image_attribution": "Arctic Circle, boundary of the Arctic seas and lands (Wikimedia Commons)"
}

def update_ecoregion_image():
    """Update Arctic Terrestrial ecoregion with Wikipedia image"""

    print("🌍 Updating Arctic Terrestrial ecoregion image...\n")
    ...
    print("✨ Done! Arctic Terrestrial image updated.")
